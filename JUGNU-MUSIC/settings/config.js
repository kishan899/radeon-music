...
const embedSettings = {
  ...
  footertext: "By K1NG | TEAM RADEON",
};
...
const links = {
  inviteURL: `https://discord.com/api/oauth2/authorize?client_id=922964160176877688&permissions=6508997968&scope=bot%20applications.commands`,
  DiscordServer: `https://discord.gg/jbPACSKnjf`,
  VoteURL: `https://discord.gg/jbPACSKnjf`,
  Website: `https://kishan.live`,
};
...
const slashSettings = {
  global: false,
  guildIDS: ["1217379405781925968"], // for slash command
};
